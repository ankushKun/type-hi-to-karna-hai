    ...
    <Page>
      <div className="flex justify-center items-center absolute top-20 left-0 z-0">
        ...
        <div className="w-1/2 min-w-[50%]">
          <div className="font-bold text-4xl m-5 leading-relaxed"><span className="text-6xl">Boost your <span className="text-[#FFD600]">income</span></span><br /> while boosting open source quality become a <span className="text-[#FFD600]">open-sourcer</span>!</div>
