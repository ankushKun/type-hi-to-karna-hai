...
contract hack is ERC721Holder {
    ...
    // Optional code of solver table update

    function solver_update(string memory _URL,uint _Sid) public {
  ...
  TablelandDeployments.get().mutate(
    ...
    // Optional code of bounty table update

    function bounty_update(string memory _title,string memory _url,string memory _desc,uint _bid) public{
    ...
    SQLHelpers.toUpdate(
      bountyTablePrefix,
      bountyTableId,
      string.concat("title=",SQLHelpers.quote(_title)),
    ...
    SQLHelpers.toUpdate(
      bountyTablePrefix,
      bountyTableId,
      string.concat("url=",SQLHelpers.quote(_url)),
      string.concat("bid=",Strings.toString(_bid))
    ));
    ...
    SQLHelpers.toUpdate(
      bountyTablePrefix,
      bountyTableId,
      string.concat("description=",SQLHelpers.quote(_desc)),
      string.concat("bid=",Strings.toString(_bid))
    ));
    }
